...
const char *argp_program_version = "Huffman v1";
static char doc[] = "Huffman";
static char args_doc[] = "TARGET [--compress | --decompress] FIN FOUT";
static struct argp_option options[] = {
    {"compress", 'c', 0, 0, "Compression mode"},
    {"decompress", 'd', 0, 0, "Decompression mode"},
    {0}};
